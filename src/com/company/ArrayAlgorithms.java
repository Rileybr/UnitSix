...
//        int[] list1 = {5, 23, 7, 14, 39, 46, 52, 65, 75, 83, 76, 44, 90, 6, 2, 5};
//        int[] list2 = {5, 23, 7, 14, 39, 46, 52, 65, 75, 83, 76, 44, 90, 6, 2, 11};
//        System.out.println(hasDupes(list1));
//        System.out.println(hasDupes(list2));
//        int[] list1 = {5, 23, 7, 14, 39, 46, 52, 65, 75, 83, 76, 44, 90, 6, 2, 5};
//        int[] list2 = {12, 3, 72, 16, 47, 46, 92, 12, 18, 36, 76, 51, 99, 101, 42, 42};
//        System.out.println(countEvens(list1));
//        System.out.println(countEvens(list2));
//        int[] list1 = {1, 0, 1, 1, 0, 1, 0, 1};
//        System.out.println(leftShift(list1, 6));
        int[] list1 = {5, 7, 4, 9, 8, 1, 4, 3, 0, 5, 2};
